...
class NotificationHelper(private val context: Context) {
    ...
    companion object {
        ...
        const val CALL_NOTIFICATION_ID = 4002
    }
    ...
    private fun createNotificationChannels() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            val callChannel = NotificationChannel(
                ...
                description = "Incoming voice calls from cab drivers"
                enableLights(true)
    ...
    fun showIncomingCallNotification(
        ...
        // 1. PendingIntent for clicking notification body (Opens CustomerIncomingCall screen)
        val intent = Intent(context, MainActivity::class.java).apply {
        ...
        val notification = NotificationCompat.Builder(context, CALL_CHANNEL_ID)
            .setContentTitle("📞 Incoming Call from Driver")
